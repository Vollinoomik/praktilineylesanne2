...
3. Ava fail index.html teise ülesande avamiseks.
4. Käivita Live Server või jooksuta selles kaustas npx http-server
5. Kasutades npx http-server leiate "Available on:" kuhu klikates avaneb brauseris lahendus.
