...
3. Ava fail consoleapp.html veebibrauseris esimese ülesande avamiseks
4. Ava fail index.html Visual Studio Code's teise ülesande avamiseks.
5. Käivita Live Server või jooksuta selles kaustas npx http-server
6. Kasutades npx http-server leiate "Available on:" kuhu klikates avaneb brauseris lahendus.
